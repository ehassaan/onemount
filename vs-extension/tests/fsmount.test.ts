...
import { accessSync, mkdirSync, readFileSync, rmSync } from 'node:fs';
import { dirname, join } from 'node:path';
import { FSMount } from "@ducklake/core";
import { MountOptions } from '@ducklake/core';


const remoteName = "mminio";
