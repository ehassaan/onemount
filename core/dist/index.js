...
class TypedEmitter {
    constructor() {
        ...
        Object.defineProperty(this, "_counterSub", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "_dispose", {
            ...
            writable: true,
            value: []
        }); // subscriptions for dispose event
        Object.defineProperty(this, "_counterDis", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
...
class RClone {
    ...
    async runCommand(args, timeout = 30000) {
        ...
        let chunks = [];
        let errors = [];
        const process = node_child_process.spawn(rclone_path, args, {
            stdio: "pipe",
            cwd: this.opts.cwd
        });
    ...
    runProcess(args) {
        ...
        let process = node_child_process.spawn(rclone_path, args, {
            cwd: this.opts.cwd,
            stdio: "pipe",
        });
        let rproc = {
...
(function (MountStatus) {
    MountStatus[MountStatus["Mounted"] = 0] = "Mounted";
    MountStatus[MountStatus["Unmounted"] = 1] = "Unmounted";
    MountStatus[MountStatus["Disposed"] = 2] = "Disposed";
})(exports.MountStatus || (exports.MountStatus = {}));
class FSMount {
    // public get status() {
    //     return this._status;
    // }
    ...
    constructor(options) {
        ...
        Object.defineProperty(this, "_remoteName", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: globalThis.crypto.randomUUID().slice(0, 16).replaceAll("-", "")
        });
        ...
        Object.defineProperty(this, "rclone", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    async createRemote(name) {
        ...
        await this.rclone.runCommand(args, 30000);
    }
    async runMountProcess(remoteName, bucket, localPath) {
    ...
    async mount() {
        ...
        await this.runMountProcess(this._remoteName, this.bucket, this._opts.localPath);
    }
    unmount() {
        if (this._process) {
...
let BackendOptions = options$1;

exports.BackendOptions = BackendOptions;
exports.FSMount = FSMount;
